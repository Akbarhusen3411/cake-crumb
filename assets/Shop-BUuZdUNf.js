import{a as e,n as t,r as n,t as r}from"./usePageMeta-BwaTi6Fl.js";import{n as i,r as a}from"./images-D8FoEGW1.js";import{B as o,N as s,O as c,P as l,R as u,V as d,f,i as p,j as m,n as h,p as g,r as _,x as v,z as y}from"./index-6KWPAIlf.js";import{t as b}from"./PageHero-DsigVu4x.js";import{t as x}from"./useJsonLd-DTtfcyja.js";var S=e(n(),1),C=t(),w={eggless:{label:`Eggless`,icon:`🌱`,kind:`free`},vegan:{label:`Vegan`,icon:`🌿`,kind:`free`},"gluten-free":{label:`Gluten-Free`,icon:`🌾`,kind:`free`},"contains-nuts":{label:`Contains Nuts`,icon:`🌰`,kind:`contains`},"contains-egg":{label:`Contains Egg`,icon:`🥚`,kind:`contains`},"contains-dairy":{label:`Contains Dairy`,icon:`🥛`,kind:`contains`},"contains-gluten":{label:`Contains Gluten`,icon:`🌾`,kind:`contains`},"eggless-option":{label:`Eggless on request`,icon:`🌱`,kind:`option`}},T={free:{bg:`rgba(34, 139, 81, 0.10)`,fg:`#1d6f3a`,border:`rgba(34, 139, 81, 0.35)`},contains:{bg:`rgba(184, 134, 11, 0.12)`,fg:`#8a5d05`,border:`rgba(184, 134, 11, 0.35)`},option:{bg:`rgba(224, 97, 122, 0.08)`,fg:`var(--cc-rose-deep)`,border:`rgba(224, 97, 122, 0.4)`}};function E({allergens:e,verbose:t=!1,size:n=`sm`}){if(!Array.isArray(e)||e.length===0)return null;let r=[`eggless`,`eggless-option`,`vegan`,`gluten-free`,`contains-nuts`],i=t?e:e.filter(e=>r.includes(e));if(i.length===0)return null;let a=n===`lg`?`0.4rem 0.7rem`:`0.18rem 0.5rem`,o=n===`lg`?`0.78rem`:`0.66rem`;return(0,C.jsx)(`div`,{className:`d-flex flex-wrap`,style:{gap:4},children:i.map(e=>{let t=w[e];if(!t)return null;let n=T[t.kind];return(0,C.jsxs)(`span`,{title:t.label,style:{display:`inline-flex`,alignItems:`center`,gap:3,fontSize:o,fontWeight:600,letterSpacing:`0.02em`,color:n.fg,background:n.bg,border:`1px solid ${n.border}`,padding:a,borderRadius:999,lineHeight:1.1,whiteSpace:`nowrap`},children:[(0,C.jsx)(`span`,{"aria-hidden":!0,style:{fontSize:`0.9em`},children:t.icon}),t.label]},e)})})}function D({product:e,onClose:t}){let{add:n}=o();if((0,S.useEffect)(()=>{if(!e)return;let n=e=>{e.key===`Escape`&&t()};return document.addEventListener(`keydown`,n),document.body.style.overflow=`hidden`,()=>{document.removeEventListener(`keydown`,n),document.body.style.overflow=``}},[e,t]),!e)return null;let r=e;function i(e){n(e),t()}return(0,C.jsxs)(`div`,{role:`dialog`,"aria-modal":`true`,"aria-label":r.name,onClick:t,className:`qv-backdrop`,children:[(0,C.jsxs)(`div`,{onClick:e=>e.stopPropagation(),className:`qv-modal`,children:[(0,C.jsx)(`button`,{onClick:t,"aria-label":`Close`,className:`qv-close`,children:(0,C.jsx)(y,{size:18})}),(0,C.jsxs)(`div`,{className:`qv-grid`,children:[(0,C.jsxs)(`div`,{className:`qv-image-col`,children:[(0,C.jsx)(`img`,{src:a(r.img,800,800),alt:r.name,className:`qv-image`}),r.badge&&(0,C.jsx)(`span`,{className:`qv-badge`,children:r.badge})]}),(0,C.jsxs)(`div`,{className:`qv-info-col`,children:[(0,C.jsx)(`div`,{className:`tag-badge mb-1`,style:{fontSize:`0.65rem`},children:r.category}),(0,C.jsx)(`h3`,{className:`qv-title`,children:r.name}),r.allergens?.length>0&&(0,C.jsx)(`div`,{className:`mt-2`,children:(0,C.jsx)(E,{allergens:r.allergens,verbose:!0})}),(0,C.jsx)(`div`,{className:`mt-3`,children:r.slice?(0,C.jsxs)(`div`,{className:`qv-price-pair`,children:[(0,C.jsxs)(`div`,{className:`qv-price-cell`,style:{background:`var(--cc-cream)`},children:[(0,C.jsx)(`div`,{className:`qv-price-label`,children:r.sizeLabel||`Whole`}),(0,C.jsx)(`div`,{className:`qv-price-amount`,children:h(r.price)})]}),(0,C.jsxs)(`div`,{className:`qv-price-cell`,style:{background:`#fff`},children:[(0,C.jsx)(`div`,{className:`qv-price-label`,children:r.sliceLabel||`Slice`}),(0,C.jsx)(`div`,{className:`qv-price-amount`,children:h(r.slice)})]})]}):(0,C.jsx)(`div`,{className:`qv-price-single`,children:(0,C.jsx)(`div`,{className:`qv-price-amount`,style:{fontSize:`1.5rem`},children:h(r.price)})})}),(0,C.jsx)(`p`,{className:`qv-desc`,children:`Handcrafted with the finest ingredients. Each order is freshly prepared. Please pre-order at least 1 day in advance.`}),(0,C.jsx)(`div`,{className:`qv-actions`,children:r.slice?(0,C.jsxs)(C.Fragment,{children:[(0,C.jsxs)(`button`,{className:`qv-btn qv-btn--outline`,onClick:()=>i({id:r.id+`-slice`,name:`${r.name} (${r.sliceLabel||`Slice`})`,price:r.slice,img:r.img}),children:[`+ `,r.sliceLabel||`Slice`]}),(0,C.jsxs)(`button`,{className:`qv-btn qv-btn--filled`,onClick:()=>i({...r,name:`${r.name} (${r.sizeLabel||`Whole`})`}),children:[(0,C.jsx)(l,{size:13}),` + `,r.sizeLabel||`Whole`]})]}):(0,C.jsxs)(`button`,{className:`qv-btn qv-btn--filled w-100`,onClick:()=>i(r),children:[(0,C.jsx)(l,{size:13}),` Add to Cart — `,h(r.price)]})}),(0,C.jsxs)(`button`,{className:`qv-fav`,children:[(0,C.jsx)(v,{size:13}),` Save to favourites`]})]})]})]}),(0,C.jsx)(`style`,{children:`
