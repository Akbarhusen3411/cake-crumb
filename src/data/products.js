...
export const shopProducts = [
  ...
  // Classic
  { id: 'cc-strawberry', name: 'Strawberry Cheesecake', price: 350, slice: 120, img: img.cheesecakeStrawberry, category: 'Cheesecakes', sizeLabel: 'Banto 4" (inch)' },
  { id: 'cc-blueberry', name: 'Blueberry Cheesecake', price: 410, slice: 140, img: img.rcCheesecakeBlueberry, category: 'Cheesecakes', sizeLabel: 'Banto 4" (inch)' },
  { id: 'cc-raspberry', name: 'Raspberry Cheesecake', price: 410, slice: 140, img: img.rcCheesecakePomegranate, category: 'Cheesecakes', sizeLabel: 'Banto 4" (inch)' },
  { id: 'cc-orange', name: 'Orange Creamsicle Cheesecake', price: 380, slice: 130, img: img.cheesecakeChocMango, category: 'Cheesecakes', sizeLabel: 'Banto 4" (inch)' },
  { id: 'cc-lemon', name: 'Lemon Cheesecake', price: 350, slice: 120, img: img.cheesecakeCookiesCream, category: 'Cheesecakes', sizeLabel: 'Banto 4" (inch)' },
  { id: 'cc-rose', name: 'Rose Cheesecake', price: 350, slice: 120, img: img.cheesecakeStrawberry, category: 'Cheesecakes', sizeLabel: 'Banto 4" (inch)' },
  // Exotic
  { id: 'cc-mango', name: 'Mango Cheesecake', price: 350, slice: 120, img: img.cheesecakeMango, category: 'Cheesecakes', sizeLabel: 'Banto 4" (inch)' },
  { id: 'cc-passion', name: 'Passion Fruit Cheesecake', price: 380, slice: 130, img: img.cheesecakeChocMango, category: 'Cheesecakes', sizeLabel: 'Banto 4" (inch)' },
  { id: 'cc-cherry', name: 'Cherry Cheesecake', price: 380, slice: 130, img: img.cheesecakeStrawberry, category: 'Cheesecakes', sizeLabel: 'Banto 4" (inch)' },
  { id: 'cc-guava', name: 'Guava Cheesecake', price: 350, slice: 120, img: img.cheesecakeMango, category: 'Cheesecakes', sizeLabel: 'Banto 4" (inch)' },
  { id: 'cc-mango-passion', name: 'Mango & Passion Cheesecake', price: 410, slice: 140, img: img.cheesecakeMango, category: 'Cheesecakes', sizeLabel: 'Banto 4" (inch)' },
  { id: 'cc-coconut', name: 'Coconut Cheesecake', price: 410, slice: 140, img: img.cheesecakeCookiesCream, category: 'Cheesecakes', sizeLabel: 'Banto 4" (inch)' },
  // Chocolate
  { id: 'cc-choc', name: 'Chocolate Cheesecake (Milk & Dark)', price: 380, slice: 130, img: img.cheesecakeChocRose, category: 'Cheesecakes', sizeLabel: 'Banto 4" (inch)' },
  { id: 'cc-choc-orange', name: 'Chocolate Orange Cheesecake', price: 380, slice: 130, img: img.cheesecakeChocMango, category: 'Cheesecakes', sizeLabel: 'Banto 4" (inch)' },
  { id: 'cc-blackforest', name: 'Black Forest Cheesecake', price: 380, slice: 130, img: img.cheesecakeChocRoseBowl, category: 'Cheesecakes', sizeLabel: 'Banto 4" (inch)' },
  { id: 'cc-choc-chunk', name: 'Chocolate Chunk Cheesecake', price: 380, slice: 130, img: img.cheesecakeChocPistachio, category: 'Cheesecakes', sizeLabel: 'Banto 4" (inch)' },
  { id: 'cc-nutella', name: 'Nutella Cheesecake', price: 440, slice: 150, img: img.cheesecakeNutella, category: 'Cheesecakes', sizeLabel: 'Banto 4" (inch)' },
  { id: 'cc-biscoff', name: 'Biscoff Cheesecake', price: 410, slice: 140, img: img.cheesecakeCaramel, category: 'Cheesecakes', sizeLabel: 'Banto 4" (inch)' },
  // Premium
  { id: 'cc-cookies-cream', name: 'Cookies & Cream Cheesecake', price: 430, slice: 150, img: img.cheesecakeCookiesCream, category: 'Cheesecakes', sizeLabel: 'Banto 4" (inch)' },
  { id: 'cc-caramel', name: 'Caramel Cheesecake', price: 430, slice: 150, img: img.cheesecakeCaramel, category: 'Cheesecakes', sizeLabel: 'Banto 4" (inch)' },
  { id: 'cc-coffee', name: 'Coffee Cheesecake', price: 430, slice: 150, img: img.cheesecakeCoffee, category: 'Cheesecakes', sizeLabel: 'Banto 4" (inch)' },
  { id: 'cc-pistachio', name: 'Pistachio Cheesecake', price: 470, slice: 160, img: img.rcCheesecakePistachio, category: 'Cheesecakes', sizeLabel: 'Banto 4" (inch)', badge: 'Premium' },
  { id: 'cc-dubai', name: 'Dubai Cheesecake', price: 500, slice: 170, img: img.cheesecakeChocPistachio, category: 'Cheesecakes', sizeLabel: 'Banto 4" (inch)', badge: 'Special' },
