...
const ORDER_ITEMS = {
  ...
  cakes: [
    ...
    { name: 'Nutella Cupcakes (6)', price: 180, cat: '🧁 Cupcakes' },
...
const MENU_DATA = {
  ...
  desserts: {
    ...
    items: [
      ...
      { n: 'Trifle Cup', p: '₹100' }, { n: 'Jelly Cup', p: '₹50' }, { n: 'Grass Cup', p: '₹90' },
    ],
  },
  drinks: {
