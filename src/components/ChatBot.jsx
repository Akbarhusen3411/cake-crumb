...
const CAT_IMAGES = {
  ...
  desserts: [
    { src: 'products/dessertcup-chocolate-mango-duo.jpeg', label: 'Cheesecake Cup' },
    { src: 'products/dessertcup-mango-custard.jpeg',       label: 'Custard Cup' },
...
const ORDER_ITEMS = {
  ...
  cakes: [
    ...
    { name: 'Mango Cupcakes (6)', price: 170, cat: '🧁 Cupcakes' },
...
const MENU_DATA = {
  ...
  cakes: {
    ...
    groups: [
      { name: 'Cupcakes · Box of 6 (+₹20 for decoration)', items: [
        ...
        { n: 'Strawberry', p: '₹170' }, { n: 'Mango', p: '₹170' },
      ]},
  ...
  desserts: {
    ...
    items: [
      ...
      { n: 'Mango Custard', p: '₹80' }, { n: 'Cheesecake Cup', p: '₹150' },
      { n: 'Trifle Cup', p: '₹100' }, { n: 'Jelly Cup', p: '₹50' }, { n: 'Ghas (Milk Pudding)', p: '₹40' },
    ],
  },
  drinks: {
